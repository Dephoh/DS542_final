...
def train_simclr(model, train_loader, optimizer, device, epoch):
    ...
    """Training loop for SimCLR with progress bar"""
...
def parse_args():
    ...
    parser.add_argument('--output-dim', type=int, default=128,
                        ...
                        help='Dimension of output embeddings (default: 128)')
    ...
    parser.add_argument('--output-dir', type=str, default='.',
                        ...
                        help='Directory to save models and checkpoints (default: current directory)')
...
def main():
    ...
    for epoch in epoch_pbar:
        ...
        if (epoch + 1) % args.checkpoint_freq == 0:
            ...
            checkpoint_path = os.path.join(args.output_dir, f'simclr_checkpoint_epoch_{epoch+1}.pth')
    ...
    model_path = os.path.join(args.output_dir, 'simclr_model_final.pth')

    encoder_path = os.path.join(args.output_dir, 'simclr_encoder_final.pth')
